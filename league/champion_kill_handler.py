...
def make_champion_kill_handler():
    ...
    def _on_streak_expired():
        ...
        if not to_hide:
            return  # nothing was showing, so logo can't be showing either
        ...
        # Hide the kill streak logo alongside the triangles
    ...
    def _reveal_next_triangle():
        ...
        # Show the KillStreakLogo — visible as long as any triangle is revealed
        if KILL_STREAK_LOGO is not None:
            try:
